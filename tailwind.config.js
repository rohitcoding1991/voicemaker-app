...
module.exports = {
  ...
  theme: {
    extend: {
      // Modern Color Palette - Professional gradient theme
      colors: {
        primary: {
          50: '#f5f3ff',
          100: '#ede9fe',
      ...
      fontSize: {
        ...
        '5xl': ['clamp(3rem, 2.55rem + 2.25vw, 4rem)', { lineHeight: '1' }],
      },
      ...
      // Box Shadow System - Modern, subtle depth
      boxShadow: {
      ...
      // Breakpoints (for responsive design from 200px to infinity)
      screens: {
        'xxs': '200px',
        'xs': '320px',
        'sm': '640px',
